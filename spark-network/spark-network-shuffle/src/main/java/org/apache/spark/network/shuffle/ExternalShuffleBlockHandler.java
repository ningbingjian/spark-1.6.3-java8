 ...
 */
/**
 * RPC Handler for a server which can serve shuffle blocks from
 * outside of an Executor process.
 *
 * Handles registering executors and opening shuffle blocks from them.
 * Shuffle blocks are registered
