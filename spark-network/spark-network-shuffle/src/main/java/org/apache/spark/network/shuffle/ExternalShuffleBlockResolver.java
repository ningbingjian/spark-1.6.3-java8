 ...
 * of Executors.
 * Each Executor must register its own configuration about where it stores its files
 * (local dirs) and how (shuffle manager).
 * The logic for retrieval of individual files is replicated
...
public class ExternalShuffleBlockResolver {
     ...
     * 根据shuffle block id获取文件块缓冲
     * 块id的格式:shuffle_ShuffleId_MapId_ReduceId
     *
     */
